...
class ModelParallelConfig:
    ...
    """Timers object to call for various timing functions. See paddlefleet.timers.Timers"""
    ...
    """
       When using batch_isend_irecv, do a cuda.device.synchronize afterward to work.
    """
